...
sudo pacman -S vim neovim nodejs npm base-devel obs-studio flameshot yay  jre8-openjdk-headless jre8-openjdk jdk8-openjdk openjdk8-doc openjdk8-src firefox-developer-edition go --noconfirm
